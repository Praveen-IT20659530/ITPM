...
function AddElectricity() {
  ...
  function sendData(e) {
    ...
    axios
      .post("http://localhost:5000/electricity/add", newElectricity)
      .then(() => {
      ...
      <div class="card-adding">
        <form onSubmit={sendData}>
          <div class="text-dark">
            <center>
              <h1>
                <strong>SAVING POWER AND MONEY</strong>
              </h1>
            </center>
            <br></br>
          </div>
          <div className="form-group">
            <label for="pannelSize">
              <strong>Pannel Size </strong>
            </label>
            <input
              type="text"
              class="form-control"
          ...
          <div className="form-group">
            <label for="intensity">
              <strong>Availability Of Intensity</strong>
            </label>
            <input
              type="text"
              class="form-control"
          ...
          <div className="form-group">
            <label for="monthlyBill">
              <strong>Last Month Electricity Bill</strong>
            </label>
            <input
              type="text"
              class="form-control"
...
"
          ...
          <div class="d-grid gap-2 col-6 mx-auto">
            ...
            <div>
              <a href="/all" class="btn btn-primary" style={{ width: "300px" }}>
